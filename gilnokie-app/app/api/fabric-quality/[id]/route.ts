  ...
  try {
    ...
    const fabricQuality = await prisma.fabricQuality.update({
      ...
      data: {
        ...
        greigeWidth: body.greigeWidth,
        greigeWeight: body.greigeWeight,
        finishedWidth: body.finishedWidth,
        finishedWeight: body.finishedWeight,
        percentageLoss: body.percentageLoss,
        fabricType: body.fabricType,
        texCount: body.texCount,
        metersPerKg: body.metersPerKg,
        width: body.width,
        weight: body.weight,
